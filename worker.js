  ...
  async fetch(request, env) {
    ...
    try {
      ...
      if (body.action === 'report_output') {
        ...
        const emailBody = `JAWS ADVANTAGE — INAPPROPRIATE OUTPUT REPORT
...
---
This report was automatically generated by The JAWS Advantage reporting system.
Review the output above and take action if necessary.`;
        ...
        await fetch('https://api.mailchannels.net/tx/v1/send', {
          ...
          body: JSON.stringify({
            personalizations: [{
              to: [{ email: 'info@jawsadvantage.com', name: 'JAWS Advantage' }]
            }],
            from: { email: 'info@jawsadvantage.com', name: 'JAWS Report System' },
            subject: 'REPORT: Inappropriate Output — ' + tool,
